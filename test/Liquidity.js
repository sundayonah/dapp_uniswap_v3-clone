...
const DAI_WHALE = "Ox97f991971a37D4Ca58064e6a98FC563F03A71E5c";
const USDC_WHALE = "Ox97f991971a37D4Ca58064e6a98FC563F03A71E5c";
...
expect(await dai.balanceOf(daiWhale.address)).to.gte(diaAmount);
expect(await usdc.balanceOf(daiWhale.address)).to.gte(usdcAmount);
